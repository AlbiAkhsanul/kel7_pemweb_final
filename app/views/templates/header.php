...
<body>
    <style>
        ...
        body::before {
            content: "";
            background-image: url('<?= BASEURL ?>/properties/mainbg_alt2.jpg') !important;
        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start navbar-fixed-top">
                ...
                <ul class="nav col-12 col-lg-auto ms-auto me-4 mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="<?= BASEURL ?>/car/allCars" class="nav-link px-2 text-white">Our Cars</a></li>
                    <li><a href="<?= BASEURL ?>/order/index" class="nav-link px-2 text-white">My Orders</a></li>
                </ul>
                <?php if (isset($_SESSION['login']) && $_SESSION['login'] == true) : ?>
                    <div class="text-end d-flex align-items-center">
                        <a href="<?= BASEURL ?>/user/index" class="nav-link px-2 text-white me-2">
                            <img width="32" height="32" alt="user" style="border-radius: 24px;" src="<?= BASEURL ?>/properties/user.png">
                            <a href="<?= BASEURL ?>/user/index" class="mb-0"> Welcome!</a>
                        </a>
                        <!-- <p> Welcome, <?php // htmlspecialchars($user['nama_user'])
                                            ?></p> -->
                    </div>
                <?php else : ?>
                    <div class="text-end">
